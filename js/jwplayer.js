        ...
        d.plugin = function(g) {
            ...
            this.load = function() {
                if (k == a.loaderstatus.NEW)
                    if (0 < g.lastIndexOf(".swf")) l = g, k = a.loaderstatus.COMPLETE, j.sendEvent(h.COMPLETE);
        ...
        d.embed.download = function(d, c, b) {
            ...
            if (r && r.length) {
                ...
                for (r = 0; r < s.length; r++) {
                    ...
                    if (u.file)
                        for (r in l) t == l[r] ? (m = u.file, j = p.image) : a.isYouTube(u.file) && (f = u.file)
                }
                ...
                function m(a, b) {
                    p[a] || (p[a] = [], q(g.JWPLAYER_PLAYER_STATE, function(b) {
                        ...
                        if (c == a) {
                            var e = p[c];
                            if (e)
                                for (var d = 0; d < e.length; d++) "function" == typeof e[d] && e[d].call(this, {
                                    oldstate: b,
                                    newstate: c
                                })
                        }
